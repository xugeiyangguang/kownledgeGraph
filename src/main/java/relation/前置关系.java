...
public class 前置关系 {
    ...
    public static List<String> getStartNodes() {
        ...
        startNodes.add("频数分布表");
        startNodes.add("频数分布直方图");
        startNodes.add("频数折线图");
        startNodes.add("随机试验");
        startNodes.add("随机现象");
        startNodes.add("随机现象");
        startNodes.add("概率");
        ...
        startNodes.add("阶乘");
        startNodes.add("组合数");
        startNodes.add("二项展开式的通项公式");
        startNodes.add("二项式系数");
    ...
    public static void main(String[] args) {
        ...
        for (String s : startNode) {
            ...
            try {
                //在这修改处理结果的路径
                OutputStream os = new FileOutputStream("C:\\Users\\27124\\Desktop\\毕业论文\\dissertation\\分类知识点及其关系\\前置关系1.txt", true);
        ...
        for (String s : endNode) {
            ...
            try {
                //在这修改处理结果的路径
                OutputStream os = new FileOutputStream("C:\\Users\\27124\\Desktop\\毕业论文\\dissertation\\分类知识点及其关系\\前置关系2.txt", true);
                PrintWriter pw=new PrintWriter(os);
